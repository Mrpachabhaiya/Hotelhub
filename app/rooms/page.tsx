  ...
  return (
    <div ref={pageRef} className="min-h-screen bg-background pt-24">
      <div className="container mx-auto px-4">
        <h1 className="page-title text-4xl md:text-5xl font-bold text-center mb-12">Our Luxurious Rooms</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {[
            ...
            <div key={index} className="room-card bg-card rounded-lg overflow-hidden shadow-lg">
              ...
              <div className="p-6">
                ...
                <div className="flex justify-between items-center">
                  <span className="text-primary text-xl font-bold">{room.price}/night</span>
