...
import { Utensils, Space as Spa, School as Pool, Dumbbell, Car, Wifi } from 'lucide-react';
  ...
  return (
    <div ref={pageRef} className="min-h-screen bg-background pt-24">
      <div className="container mx-auto px-4">
        <h1 className="page-title text-4xl md:text-5xl font-bold text-center mb-12">Our Premium Services</h1>
        
        <div className="services-grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <div key={index} className="service-card bg-card p-6 rounded-lg shadow-lg">
