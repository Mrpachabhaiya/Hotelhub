    ...
    const ctx = gsap.context(() => {
      ...
      if (animationRefs.hero?.current) {
        ...
        heroTl
          ...
          .from(animationRefs.hero.current.querySelector('.hero-title'), {
            opacity: 0,
            y: 50,
            duration: 1
          }, '-=0.3')
          .from(animationRefs.hero.current.querySelector('.hero-description'), {
            opacity: 0,
            y: 30,
            duration: 1
          }, '-=0.3')
          .from(animationRefs.hero.current.querySelector('.hero-button'), {
            opacity: 0,
            y: 30,
            duration: 1
          }, '-=0.3');
      ...
      if (animationRefs.about?.current) {
        ...
        aboutTl
          ...
          .from(animationRefs.about.current.querySelector('p'), {
            opacity: 0,
            y: 30,
            duration: 1
          }, '-=0.5')
          .from(animationRefs.about.current.querySelector('img'), {
            opacity: 0,
            scale: 0.8,
            duration: 1
          }, '-=0.5')
          .from(animationRefs.about.current.querySelector('.stats-card'), {
            opacity: 0,
            x: 30,
            duration: 1
          }, '-=0.5');
      ...
      if (animationRefs.rooms?.current) {
        ...
        roomsTl
          ...
          .from(animationRefs.rooms.current.querySelectorAll('.room-card'), {
            opacity: 0,
            y: 50,
            duration: 1,
            stagger: 0.2
      ...
      if (animationRefs.whyChooseUs?.current) {
        ...
        whyChooseUsTl
          ...
          .from(animationRefs.whyChooseUs.current.querySelector('img'), {
            opacity: 0,
            scale: 0.8,
            duration: 1
          }, '-=0.5')
          .from(animationRefs.whyChooseUs.current.querySelectorAll('.feature-card'), {
            opacity: 0,
            y: 30,
            duration: 1,
            stagger: 0.2
      ...
      if (animationRefs.services?.current) {
        ...
        servicesTl
          ...
          .from(animationRefs.services.current.querySelectorAll('.service-card'), {
            opacity: 0,
            y: 30,
            scale: 0.9,
            duration: 0.8,
      ...
      if (animationRefs.testimonials?.current) {
        ...
        testimonialsTl
          ...
          .from(animationRefs.testimonials.current.querySelectorAll('.testimonial-card'), {
            opacity: 0,
            y: 30,
            rotation: 5,
            duration: 0.8,
      ...
      if (animationRefs.footer?.current) {
        ...
        footerTl
          .from(animationRefs.footer.current.querySelectorAll('.footer-column'), {
            opacity: 0,
            y: 30,
            duration: 0.8,
            stagger: 0.2
          })
          .from(animationRefs.footer.current.querySelector('.footer-bottom'), {
            opacity: 0,
            y: 20,
            duration: 0.8
          }, '-=0.4');
